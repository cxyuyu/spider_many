 ...
 */
public class Get_word_3_shanghai implements Runnable {
...
//                System.out.println(content);
                ...
                appendMethodB("/home/cxyu/tmp/cpws_shang_wei/"+id+"-"+i,url+"\n"+ title+  "\n" + content);
                ...
                appendMethodB("/home/cxyu/tmp/cpws_shang/"+id+"-"+i,content);
            }
            catch (Exception e){
            e.printStackTrace();
            }
...
//        }
        ...
        Get_word_3_shanghai get_word=new Get_word_3_shanghai();
        for(int i=0;i<1;i++){
